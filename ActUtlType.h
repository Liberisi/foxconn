/****************************************************************************
**
** Namespace ActUtlTypeLib generated by dumpcpp v5.6.3 using
** C:\Qt\Qt5.6.3\5.6.3\msvc2013\bin\dumpcpp.exe -o ActUtlType C:\MELSEC\Act\Control\ActUtlType.dll
** from the type library C:\MELSEC\Act\Control\ActUtlType.dll
**
****************************************************************************/

#ifndef QAX_DUMPCPP_ACTUTLTYPE_H
#define QAX_DUMPCPP_ACTUTLTYPE_H
...
public:
    ...
    : QAxWidget(parent, f)
    {
        setControl("{63885648-1785-41a4-82d5-c578d29e4da8}");
    }
...
public:
    ...
    : QAxWidget(parent, f)
    {
        setControl("{29de4b06-c429-420a-b3b7-bf7dc62649b2}");
    }
