...
public:
    ...
    QLabel *label;
    QSpinBox *spinBox_frame_exposure_time;
    ...
    void setupUi(QDialog *Frame_Dialog)
    {
        ...
        spinBox_frame_exposure_time = new QSpinBox(frame_2);
        spinBox_frame_exposure_time->setObjectName(QStringLiteral("spinBox_frame_exposure_time"));
        spinBox_frame_exposure_time->setMaximum(999999);

        verticalLayout_2->addWidget(spinBox_frame_exposure_time);
    ...
    void retranslateUi(QDialog *Frame_Dialog)
    {
        ...
        label->setText(QApplication::translate("Frame_Dialog", "\346\224\257\346\236\266\347\233\270\346\234\272\346\233\235\345\205\211\345\217\202\346\225\260", Q_NULLPTR));
